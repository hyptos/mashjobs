define([
...
], function($, _, Backbone, Moment, IndexTemplate, CbModel, IndeedModel, MashupModel, CountryModel, CountriesCollection, CBCollection, INCollection) {
    'use strict';
    ...
    var indexView = Backbone.View.extend({
        ...
        compareString: function(left, right) {
        ...
        alignmentSearchAction: function(e) {
            ...
            var longitude = (parseFloat(this.scb.get('locationLongitude')) + parseFloat(this.sid.get('longitude'))) / 2;
            var latitude = (parseFloat(this.scb.get('locationLatitude')) + parseFloat(this.sid.get('latitude'))) / 2;
            var title = this.compareString(this.scb.get('title'), this.sid.get('jobtitle'));
            var company = this.compareString(this.scb.get('company'), this.sid.get('company'));
            var id = this.idConversion(title, company);
            var date = this.compareDate();
            ...
            this.mashup.set({
                ...
                distance: this.scb.get('distance'),
                longitude: longitude,
                latitude: latitude,
